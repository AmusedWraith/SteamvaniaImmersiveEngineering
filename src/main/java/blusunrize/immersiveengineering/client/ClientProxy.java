...
public class ClientProxy extends CommonProxy
{
	...
	public void postInit()
	{
		...
		ManualHelper.addEntry("metalconstruction", ManualHelper.CAT_CONSTRUCTION,
				...
				new ManualPages.Crafting(ManualHelper.getManual(), "", new ItemStack(IEContent.blockMetalDecoration,1,BlockMetalDecoration.META_fence),new ItemStack(IEContent.blockMetalDecoration,1,BlockMetalDecoration.META_scaffolding)));
		...
		ManualHelper.addEntry("multiblocks", ManualHelper.CAT_CONSTRUCTION,
				...
				new ManualPages.Crafting(ManualHelper.getManual(), "", new ItemStack(IEContent.blockMetalDecoration,1,BlockMetalDecoration.META_radiator)));
