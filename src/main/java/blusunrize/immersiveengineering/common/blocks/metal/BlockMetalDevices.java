...
public class BlockMetalDevices extends BlockIEBase implements blusunrize.aquatweaks.api.IAquaConnectable
{
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		//7 capacitorHV
		icons[META_capacitorHV][0] = iconRegister.registerIcon("immersiveengineering:metal_capacitorHV_bottom_none");
		icons[META_capacitorHV][1] = iconRegister.registerIcon("immersiveengineering:metal_capacitorHV_top_none");
		icons[META_capacitorHV][2] = iconRegister.registerIcon("immersiveengineering:metal_capacitorHV_side_none");
		icons[META_capacitorHV][3] = iconRegister.registerIcon("immersiveengineering:metal_capacitorHV_side_none");
		for(int i=0;i<3;i++)
		{
			String s = i==0?"none":i==1?"in":"out";
		...
		//9 dynamo
		icons[META_dynamo][0] = iconRegister.registerIcon("immersiveengineering:metal_dynamo_bottom");
