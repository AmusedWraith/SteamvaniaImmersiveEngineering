...
public class BlockMetalMultiblocks extends BlockIEBase implements ICustomBoundingboxes
{
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		icons[META_squeezer][2] = iconRegister.registerIcon("immersiveengineering:metal_multiblockSqueezer0");
		icons[META_squeezer][3] = iconRegister.registerIcon("immersiveengineering:metal_multiblockSqueezer1");
		//2 fermenter
		icons[META_fermenter][0] = iconRegister.registerIcon("immersiveengineering:metal_fermenter");
		icons[META_fermenter][1] = iconRegister.registerIcon("immersiveengineering:metal_multiblockTop");
		...
		for(int i=0;i<4;i++)
		{
			icons[META_bucketWheel][i] = iconRegister.registerIcon("immersiveengineering:storage_Steel");
			icons[META_tank][i] = iconRegister.registerIcon("immersiveengineering:storage_Steel");
			icons[META_silo][i] = iconRegister.registerIcon("immersiveengineering:storage_Steel");
		}
	}
	@Override
	@SideOnly(Side.CLIENT)
