...
public class IERecipes
{
	...
	public static void initCraftingRecipes()
	{
		...
		addOredictRecipe(new ItemStack(IEContent.itemToolUpgrades,1,9), "WWW","HHH", 'W',"ingotIron", 'H',new ItemStack(IEContent.blockMetalDevice,1,BlockMetalDevices.META_capacitorHV));
