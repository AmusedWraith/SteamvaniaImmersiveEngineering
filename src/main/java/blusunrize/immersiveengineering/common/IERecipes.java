...
public class IERecipes
{
	...
	public static void initCraftingRecipes()
	{
		...
		addOredictRecipe(new ItemStack(IEContent.itemToolUpgrades,1,2), " SS","PPH"," SS", 'P',new ItemStack(IEContent.blockMetalDevice2,1,BlockMetalDevices2.META_fluidPipe), 'H',Blocks.hopper, 'S',"ingotSteel");
		...
		addOredictRecipe(new ItemStack(IEContent.blockStorage,1,8), "WWW","WIW","WWW", 'W',"ingotCopper",'I',"ingotIron");
		...
		addOredictRecipe(new ItemStack(IEContent.blockMetalDevice,1, BlockMetalDevices.META_dynamo), "RCR","III", 'C',"ingotCopper",'I',"ingotIron",'R',"dustRedstone");
